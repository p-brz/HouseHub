...
class HomeObjectManager {
    ...
    public function saveObject(HomeObject $homeObject, PDO $driver, $saveThisOnly = false) {
        ...
        $savedServices = $this->saveServices($savedStructure->getId(), $homeObject->getServices(), $driver);
        $savedStatus = $this->saveStatus($savedStructure->getId(), $homeObject->getStatus(), $driver);
        ...
        if (!$saveThisOnly && !is_null($homeObject->getSubObjects())) {
            $savedSubobjects = $this->saveSubobjects($savedStructure->getId(), $homeObject->getSubObjects(), $driver);
